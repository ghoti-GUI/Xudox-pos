...
export const EnglishText = {
    ...
    'product':{
        ...
        'TVA_category':['TVA'],
        'fetchTVAFailed':'fetch TVA datas failed', 
        ...
        'fetchPrintersfailed':'Fetch printers failed',
...
export const EnglishAllergen = {
    'gluten':'Cereals container of gluten', 
    'crustacean':'Crustaceans products', 
    'egg':'Eggs products', 
    'peanut':'Peanuts products', 
    'fish':'Fish products', 
    'soya':'Soybean and soya products', 
    'milk':'Milk products (including lactose)', 
    'nut':'Nuts and products thereof', 
    'celery':'Celery products', 
    'mustard':'Mustard products', 
    'sesame':'Sesame and sesame products', 
    'sulfur':'Sulfur dioxide and sulphites in concentrations of more than 10 mg/kg or 10 mg/L',
    'lupin':'Lupin products', 
    'molluscs':'Molluscs products', 
}